...
<div class="wrapper">
	<h6 style="text-align: center; padding-top: 1%; color: blue;font-weight: bold;font-size: 2rem;">BUFF LIKE INSTAGRAM </h6>
		<hr>
	<div class="row">

		<div class="col-12 col-md-8 ">
			<div class="col-12 ">
<form action="{{route('post_instalike')}}" method="post">
	{!!csrf_field()!!}
				<table border="0">
	    			<tr>
	    			...
	    			<tr>
				        ...
				        <td>
							<input type="number" id="dongia" name="dongia" min="70" value="70">
						</td>
	    			</tr>
	    			<tr>
				        <td ></td>
				        <td>
							<p class="nen">Giá thấp nhất: 70 coin</p>
						</td>
	    			</tr>
	    			<tr>
