...
<div class="wrapper">
	<h6 style="text-align: center; padding-top: 1%; color: blue;font-weight: bold;font-size: 2rem;">HỆ THỐNG BẢO MẬT VÀ BẢO KÊ FACEBOOK</h6>
		<hr>
	<div class="row">

		<div class="col-12 col-md-8 ">
			<div class="col-12 ">
<form action="{{route('post_fbsecurity')}}" method="post">
	{!!csrf_field()!!}
				<table border="0">
	    			<tr>
	    			...
	    			<tr>
				        ...
				        <td>
							<select class="form-control" list="loaibaomat" id="loaibaomat" name='loaibaomat'>
							  <option value="Bảo mật chống các lỗi thường gặp, chống xâm phạm quyền riêng tư">Bảo mật chống các lỗi thường gặp, chống xâm phạm quyền riêng tư</option>
							  <option value="Bảo mật theo tháng, chống rip hoàn toàn, chống toàn bộ các lỗi, bảo mật 24/7">Bảo mật theo tháng, chống rip hoàn toàn, chống toàn bộ các lỗi, bảo mật 24/7</option>
							  <option value="Bảo mật chống rip, cải thiện và tăng tương tác, 3k theo dõi thật + vip like 100">Bảo mật chống rip, cải thiện và tăng tương tác, 3k theo dõi thật + vip like 100</option>
							</select> 
						</td>
	    			</tr>
	    			<tr>
