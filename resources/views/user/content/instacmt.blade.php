...
<div class="wrapper">
	<h6 style="text-align: center; padding-top: 1%; color: blue;font-weight: bold;font-size: 2rem;">BUFF COMMENT INSTAGRAM</h6>
		<hr>
	<div class="row">

		<div class="col-12 col-md-8 ">
			<div class="col-12 ">
<form action=" {{route('post_instacmt')}}" method="post">
	{!!csrf_field()!!}
				<table border="0">
	    			<tr>
	    			...
	    			<tr>
				        <td ></td>
				        <td>
							<p class="nen">Giá thấp nhất: 1000 coin</p>
						</td>
	    			</tr>
	    			<tr>
				        <td ></td>
